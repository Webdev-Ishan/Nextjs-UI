...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full w-full border border-transparent dark:bg-black  bg-black shadow-input flex justify-evenly items-center space-x-6 px-6 py-4 "
    >
      {children}
    </nav>
  );
